...
export const SPIKE_USAGE = [
  'MCPwn hypothesis spike — a local, sandboxed MCP server serving one poisoned-tool-DESCRIPTION surface.',
  '',
  'Usage: <node …> scripts/spike/asi04-stdio.ts --framing <malicious|benign> [options]',
  '',
  '  --framing <malicious|benign>  REQUIRED. Which framing to serve. The poisoned',
  '                                run and its control differ in exactly one field:',
  '                                the DESCRIPTION of the read tool in tools/list.',
  '                                The email body is clean in both.',
