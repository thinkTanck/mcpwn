      ...
      <div className="border-t border-line pt-5">
        ...
        <div className="flex flex-wrap items-center gap-4">
          {live ? (
            ...
            <Link
              href="/runs/sample"
              className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-md border border-nominal bg-nominal/10 px-5 py-3 font-mono text-[13px] tracking-[0.08em] text-readout shadow-glow-nominal transition-colors hover:bg-nominal/20"
            >
              <svg width="12" height="12" viewBox="0 0 12 12" aria-hidden="true">
                <polygon points="2,1 11,6 2,11" fill="currentColor" />
              </svg>
